...
tldr: 针对车联网中联邦学习面临的通信开销大和环境动态变化等挑战，本文提出了一种名为Fed-DLoRA的轻量级算法。该方法结合低秩自适应（LoRA）技术，通过动态调整秩、带宽和车辆选择，显著降低了参数量和通信成本。研究还通过收敛性分析建立了秩选择与系统性能的理论联系，并提出了ARBVS算法优化资源调度，实现了高效的模型训练。
source: arxiv
selection_source: fresh_fetch
figures_json: "[{\"url\": \"assets/figures/arxiv/2604.24103v1/fig-001.webp\", \"caption\": \"\", \"page\": 3, \"index\": 1, \"width\": 816, \"height\": 667}]"
motivation: 旨在解决车联网环境下联邦学习的高通信开销以及动态环境对模型训练效率的影响。
method: 提出结合LoRA的Fed-DLoRA算法，并利用ARBVS算法动态优化秩选择、带宽分配和车辆参与策略。
result: 实验结果显示，该方法在提高模型准确率的同时，显著加快了收敛速度并提升了通信效率。
conclusion: Fed-DLoRA通过动态低秩自适应和联合资源优化，为资源受限的无线联邦学习场景提供了一种高效的解决方案。
---
